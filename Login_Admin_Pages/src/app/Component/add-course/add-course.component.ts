...
export class AddCourseComponent {
  ...
  people: any[] = JSON.parse(localStorage.getItem("add_course_details"));
  data_length: string = JSON.parse(localStorage.getItem("add_course_details")).length;
  ...
  submitTableData() {
    ...
    if (this.isdata_deleted) {
      ...
      this.inputData.firstpopupInput = this.popupInput;
      this.inputData.secodepopupInput = this.secondPopupInput;
      let details = JSON.parse(localStorage.getItem("add_course_details"));
      details[this.index] = this.inputData;
      console.log("hello", this.inputData, this.index, details, this.isdata_deleted);
      localStorage.setItem("add_course_details", JSON.stringify(details))
      this.data_length = JSON.parse(localStorage.getItem("add_course_details")).length;
      this.showList()
      this.resetFields();
      ...
      localStorage.setItem("add_course_details", JSON.stringify(details))
      this.data_length = JSON.parse(localStorage.getItem("add_course_details")).length;
      console.log("details", localStorage.getItem("add_course_details"))
      this.showList()
      this.resetFields();
    }
  ...
  deleteItem(index: number) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        localStorage.setItem("add_course_details", JSON.stringify(this.people));
        this.data_length = JSON.parse(localStorage.getItem("add_course_details")).length;
        Swal.fire(
          'Deleted!',
